...
if __name__ == "__main__":
    ...
    for nos in range(11):
        ...
        for i in range(1000):
            ...
            # Log
            curr = time.time()
            print('[nos = {} id = {} time : {:.1f}s]'.format(nos, i, curr - start))
            ...
            # Generate.
            savename = '/media/wavenz/新加卷/graph/noise{}/{}.npy'.format(nos, i)
            x = G.generate(pitch, yaw, roll, dps * pitchspd, dps * yawspd, dps * rollspd, exposure=100, starsize=1.2, noise=nos, savename=savename)
            # np.save('/media/wavenz/新加卷/graph/noise{}/{}.npy'.format(nos, i), x.T)
   
            # # Save
            # img = Image.fromarray(img)
            # img = img.convert('L')
            # img.save('E:/graph/noise{}/{}.png'.format(nos, i))
